    ...
    <div id="translateForm">
        ...
        <div class="option-box">
            ...
            <div class="option-list">
                <p v-for="(option,index) in option_list" :key="index" v-on:click="selectOption(index)">{{option}}</p>
            </div>
            <input type="button" value="翻译" v-on:click="my_translate()">
        </div>
        <!--用户输入要翻译的文字-->
        <form class="my-form">
            <textarea class="my-textarea"  placeholder="请输入要翻译的文字" v-model="translating_text"
